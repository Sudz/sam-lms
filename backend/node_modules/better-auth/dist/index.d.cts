...
export { g as generateState, p as parseState } from './shared/better-auth.D-V8F56U.cjs';
...
export { O as OAuth2Tokens, a as OAuth2UserInfo, b as OAuthProvider, P as ProviderOptions } from './shared/better-auth.7zTmTxT4.cjs';
...
declare function getTelemetryAuthConfig(options: BetterAuthOptions, context?: TelemetryContext): {
    ...
    user: {
        ...
        additionalFields: {
            [key: string]: packages_core_dist_db.DBFieldAttribute;
        } | undefined;
        changeEmail: {
