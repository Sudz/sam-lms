...
import { I as InferOptionSchema, d as AuthContext, G as GenericEndpointContext, H as HookEndpointContext } from '../../shared/better-auth.B6vltShC.mjs';
    ...
    user: {
        fields: {
            username: {
                ...
                returned: true;
                transform: {
                    input(value: packages_core_dist_db.DBPrimitive): string | null | undefined;
                };
            };
            displayUsername: {
                type: "string";
