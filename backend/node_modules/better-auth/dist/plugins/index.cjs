...
const organization = require('../shared/better-auth.CHSXbSYZ.cjs');
...
const admin = require('../shared/better-auth.B_KiGDcg.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.B04ziJkQ.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.DWqB3pRb.cjs');
