import { b as OAuthProvider, S as SocialProviders, c as SocialProviderList, O as OAuth2Tokens, a as OAuth2UserInfo } from './better-auth.7zTmTxT4.cjs';
...
import { DBFieldAttribute, DBFieldType, DBFieldAttributeConfig, BetterAuthDBSchema } from '@better-auth/core/db';
...
export { levels as $, init as J, requestPasswordResetCallback as a$, shouldPublishLog as a0, createLogger as a4, logger as a5, createInternalAdapter as a6, createFieldAttribute as a8, setSessionCookie as aA, deleteSessionCookie as aB, parseCookies as aC, getSessionCookie as aE, getCookieCache as aF, parseSetCookieHeader as aG, checkEndpointConflicts as aH, getEndpoints as aI, router as aJ, signInSocial as aK, signInEmail as aL, callbackOAuth as aM, getSessionQuerySchema as aN, getSession as aO, getSessionFromCtx as aP, sessionMiddleware as aQ, sensitiveSessionMiddleware as aR, requestOnlySessionMiddleware as aS, freshSessionMiddleware as aT, listSessions as aU, revokeSession as aV, revokeSessions as aW, revokeOtherSessions as aX, signOut as aY, requestPasswordReset as aZ, forgetPassword as a_, coreSchema as ai, accountSchema as aj, userSchema as ak, sessionSchema as al, verificationSchema as am, parseUserOutput as an, parseAccountOutput as ao, parseSessionOutput as ap, parseInputData as aq, parseUserInput as ar, parseAdditionalUserInput as as, parseAccountInput as at, parseSessionInput as au, mergeSchema as av, createCookieGetter as aw, getCookies as ax, setCookieCache as az, BASE_ERROR_CODES as b, forgetPasswordCallback as b0, resetPassword as b1, createEmailVerificationToken as b2, sendVerificationEmailFn as b3, sendVerificationEmail as b4, verifyEmail as b5, updateUser as b6, changePassword as b7, setPassword as b8, deleteUser as b9, deleteUserCallback as ba, changeEmail as bb, error as bc, ok as bd, signUpEmail as be, listUserAccounts as bf, linkSocialAccount as bg, unlinkAccount as bh, getAccessToken as bi, refreshToken as bj, accountInfo as bk, originCheckMiddleware as bl, originCheck as bm, checkPassword as g, optionsMiddleware as p, createAuthMiddleware as q, createAuthEndpoint as r, setCookieToHeader as s, betterAuth as x };
export type { AdapterDebugLogs as A, BetterAuthOptions as B, CustomAdapter as C, AdditionalSessionFieldsInput as D, AdditionalSessionFieldsOutput as E, InferPluginTypes as F, GenericEndpointContext as G, HookEndpointContext as H, InferOptionSchema as I, KyselyDatabaseType as K, Where as L, Models as M, TransactionAdapter as N, AdapterSchemaCreation as O, AdapterInstance as P, SecondaryStorage as Q, RateLimit as R, Session as S, TelemetryContext as T, User as U, Verification as V, WithJsDoc as W, FilteredAPI as X, FilterActions as Y, InferSessionAPI as Z, LogLevel as _, Adapter as a, Logger as a1, LogHandlerParams as a2, InternalLogger as a3, InternalAdapter as a7, InferValueType as a9, EligibleCookies as aD, InferFieldsOutput as aa, InferFieldsInput as ab, InferFieldsInputClient as ac, FieldAttributeToObject as ad, InferAdditionalFieldsFromPluginOptions as ae, PluginFieldAttribute as af, InferFieldsFromPlugins as ag, InferFieldsFromOptions as ah, BetterAuthCookies as ay, Auth as c, AuthContext as d, InferUser as e, InferSession as f, InferAPI as h, AdapterFactoryOptions as i, AdapterFactoryConfig as j, AdapterFactoryCustomizeAdapterCreator as k, AdapterTestDebugLogs as l, AuthPluginSchema as m, BetterAuthPlugin as n, InferPluginErrorCodes as o, AuthEndpoint as t, AuthMiddleware as u, Account as v, TelemetryEvent as w, AdditionalUserFieldsInput as y, AdditionalUserFieldsOutput as z };
